function generate_years(start, end) {
  ...
  createYear = generate_years(1970, 2050);
  ...
  $dataHead += "</tr>";
  document.getElementById("table-header-month").innerHTML = $dataHead;
  monthAndYear = document.getElementById("monthAndYear");console.log(monthAndYear)
  ...
  const btn = document.getElementsByClassName("enterButtonfordate");
